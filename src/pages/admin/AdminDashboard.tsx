...
`;
  ...
  return (
    <div className="h-screen max-h-screen w-full overflow-hidden bg-[#F4F6F9] flex text-slate-800 font-sans relative">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 h-screen h-full ${
      ...
      <div className={`flex-1 h-screen overflow-y-auto overflow-x-hidden flex flex-col min-w-0 ${isSidebarCollapsed ? 'lg:pl-20' : 'lg:pl-64'} transition-all duration-300`}>
