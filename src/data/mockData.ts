...
export const INITIAL_CHIT_GROUPS: any[] = [
  {
    id: 'group-50k',
    name: '₹50,000 Starter Chit Group',
    total_value: 50000,
    monthly_amount: 2500,
    members_limit: 20,
    duration_months: 20,
    current_members_count: 14,
    status: 'active',
    next_auction_date: new Date(Date.now() + 5 * 24 * 60 * 60 * 1000).toISOString(),
    created_at: '2026-01-01T10:00:00Z',
  },
  {
    id: 'group-100k',
    name: '₹1,00,000 Harvest Chit Group',
    total_value: 100000,
    monthly_amount: 5000,
    members_limit: 20,
    duration_months: 20,
    current_members_count: 18,
    status: 'active',
    next_auction_date: new Date(Date.now() + 3 * 24 * 60 * 60 * 1000).toISOString(),
    created_at: '2026-02-01T10:00:00Z',
  },
  {
    id: 'group-500k',
    name: '₹5,00,000 Premium Prosperity Chit Group',
    total_value: 500000,
    ...
    status: 'recruiting',
    next_auction_date: new Date(Date.now() + 10 * 24 * 60 * 60 * 1000).toISOString(),
    created_at: '2026-03-01T10:00:00Z',
  },
];

export const INITIAL_AUCTIONS: any[] = [
  {
    id: 'auction-50k-m5',
    group_id: 'group-50k',
    group_name: '₹50,000 Starter Chit Group',
    auction_month: 5,
    auction_date: new Date(Date.now() + 2 * 24 * 60 * 60 * 1000).toISOString(),
    winner_user_id: undefined,
    winner_name: undefined,
    winning_discount_bid: 5000,
    prize_amount: 45000,
    status: 'live',
  },
  {
